...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText2 = new wxStaticText( this, wxID_ANY, _("Contrast"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_b_prewitt = new wxButton( this, wxID_ANY, _("Prewitt Mask"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer2->Add( m_b_prewitt, 0, wxALIGN_CENTER|wxALL|wxEXPAND, 5 );
	
	m_b_threshold = new wxButton( this, wxID_ANY, _("Threshold 128"), wxDefaultPosition, wxDefaultSize, 0 );
