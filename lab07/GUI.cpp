...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	sbSizer1 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _("Mapping type") ), wxHORIZONTAL );
	
	sbSizer1->SetMinSize( wxSize( -1,60 ) ); 
	m_cb_Kontur = new wxCheckBox( sbSizer1->GetStaticBox(), wxID_ANY, _("Contour"), wxDefaultPosition, wxDefaultSize, 0 );
	m_cb_Kontur->SetValue(true); 
	sbSizer1->Add( m_cb_Kontur, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_cb_Mapa = new wxCheckBox( sbSizer1->GetStaticBox(), wxID_ANY, _("Map"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer1->Add( m_cb_Mapa, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_rb_NC = new wxRadioButton( sbSizer1->GetStaticBox(), wxID_ANY, _("Blue/Red"), wxDefaultPosition, wxDefaultSize, 0 );
	m_rb_NC->SetValue( true ); 
	m_rb_NC->Enable( false );
	
	sbSizer1->Add( m_rb_NC, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_rb_NZC = new wxRadioButton( sbSizer1->GetStaticBox(), wxID_ANY, _("Blue/Green/Red"), wxDefaultPosition, wxDefaultSize, 0 );
	m_rb_NZC->Enable( false );
	
	sbSizer1->Add( m_rb_NZC, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_rb_Na_szaro = new wxRadioButton( sbSizer1->GetStaticBox(), wxID_ANY, _("Gray"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer2 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _("Choose function") ), wxHORIZONTAL );
	...
	m_st_liczba_poziomic = new wxStaticText( this, wxID_ANY, _("Levels: 5"), wxDefaultPosition, wxDefaultSize, 0 );
